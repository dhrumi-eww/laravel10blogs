...
(function (root, factory) {
  ...
  function (window) {
    ...
    var notiflixGoogleFont = function (use, family) {
      if (
        !window.document.getElementById("NotiflixQuicksand") &&
        use &&
        family &&
        typeof family === "string" &&
        family.toLowerCase() === "quicksand"
      ) {
    ...
    var NotiflixNotify = function (message, callback, theType, staticType) {
      if (arguments && arguments.length === 4) {
        ...
        if (
          ...
          message =
            '<b>HTML Tags Error:</b> Your content length is more than "messageMaxLength" option.'; // message html error
        }
        ...
        if (newNotifySettings.backOverlay) {
          ...
          notifyOverlay.className = newNotifySettings.cssAnimation
            ? "with-animation"
            : "";
        ...
        ntflxNotify.className =
          ...
          " " +
          (newNotifySettings.closeButton && !callback
            ? "with-close-button"
            : "") +
          " " +
        ...
        if (newNotifySettings.useIcon) {
          ...
          var messageText = window.document
            .getElementById(ntflxNotify.id)
            .querySelectorAll("span")[0];
          var messageTextH = Math.round(messageText.offsetHeight);
          if (messageTextH <= messageIconH) {
            messageText.style.paddingTop =
              (messageIconH - messageTextH) / 2 + "px";
            messageText.style.paddingBottom =
              (messageIconH - messageTextH) / 2 + "px";
          }
        }
        ...
        if (window.document.getElementById(ntflxNotify.id)) {
          ...
          var hideNotifyElementsAndOverlay = function () {
            ...
            if (
              ...
              removeWrap.childElementCount <= 0
            ) {
    ...
    var NotiflixReport = function (
      ...
      if (!newReportSettings.plainText) {
        if (title.length > newReportSettings.titleMaxLength) {
          ...
          message =
            'Your Title content length is more than "titleMaxLength" option.'; // message html error
          buttonText = "Okay"; // button html error
        }
        if (message.length > newReportSettings.messageMaxLength) {
          title = "HTML Tags Error"; // title html error
          message =
            'Your Message content length is more than "messageMaxLength" option.'; // message html error
          buttonText = "Okay"; // button html error
        }
        if (buttonText.length > newReportSettings.buttonMaxLength) {
          title = "HTML Tags Error"; // title html error
          message =
            'Your Button content length is more than "buttonMaxLength" option.'; // message html error
          buttonText = "Okay"; // button html error
        }
      }
      ...
      ntflxReportWrap.style.fontFamily =
        '"' + newReportSettings.fontFamily + '"' + ", sans-serif";
      ...
      var svgIcon = "";
      if (staticType === "Success") {
        svgIcon = notiflixReportSvgSuccess(
          newReportSettings.svgSize,
          theType.svgColor
        );
      } else if (staticType === "Failure") {
        svgIcon = notiflixReportSvgFailure(
          newReportSettings.svgSize,
          theType.svgColor
        );
      } else if (staticType === "Warning") {
        svgIcon = notiflixReportSvgWarning(
          newReportSettings.svgSize,
          theType.svgColor
        );
      } else if (staticType === "Info") {
      ...
      if (!window.document.getElementById(ntflxReportWrap.id)) {
        ...
        var reportH = Math.round(
          window.document.getElementById(ntflxReportWrap.id).offsetHeight
        );
    ...
    var NotiflixConfirm = function (
      ...
      if (!newConfirmSettings.plainText) {
        ...
        if (
          (okButtonText.length || cancelButtonText.length) >
          newConfirmSettings.buttonsMaxLength
        ) {
          title = "HTML Tags Error"; // title html error
          message =
            'Your Buttons contents length is more than "buttonsMaxLength" option.'; // message html error
          okButtonText = "Okay"; // button html error
          cancelButtonText = "..."; // button html error
        }
      }
      ...
      if (message.length > newConfirmSettings.messageMaxLength) {
        message =
          message.substring(0, newConfirmSettings.messageMaxLength) + "...";
      }
      if (okButtonText.length > newConfirmSettings.buttonsMaxLength) {
        okButtonText =
          okButtonText.substring(0, newConfirmSettings.buttonsMaxLength) +
          "...";
      }
      ...
      if (!window.document.getElementById(ntflxConfirmWrap.id)) {
        ...
        if (newConfirmSettings.position === "center") {
          // if center-center
          var windowH = Math.round(window.innerHeight);
          var confirmH = Math.round(
            window.document.getElementById(ntflxConfirmWrap.id).offsetHeight
          );
        ...
        // buttons listener on
        var confirmCloseWrap = window.document.getElementById(
          ntflxConfirmWrap.id
        );
        ...
        if (okButtonCallback && typeof okButtonCallback === "function") {
          ...
          var cancelButton = window.document.getElementById(
    ...
    var NotiflixLoading = function (message, iconType, display, theDelay) {
      ...
      if (display) {
        ...
        if (message.length > 0) {
          var messagePosTop =
            Math.round(intSvgSize - intSvgSize / 4).toString() + "px";
          var messageHeight =
            (parseInt(newLoadingSettings.messageFontSize) * 1.4).toString() +
            "px";
          messageHTML =
            '<p id="' +
        ...
        if (iconType === "standard") {
          svgIcon = notiflixIndicatorSvgStandard(
            newLoadingSettings.svgSize,
            newLoadingSettings.svgColor
          );
        } else if (iconType === "hourglass") {
          svgIcon = notiflixIndicatorSvgHourglass(
            newLoadingSettings.svgSize,
            newLoadingSettings.svgColor
          );
        } else if (iconType === "circle") {
          svgIcon = notiflixIndicatorSvgCircle(
            newLoadingSettings.svgSize,
            newLoadingSettings.svgColor
          );
        } else if (iconType === "arrows") {
          svgIcon = notiflixIndicatorSvgArrows(
            newLoadingSettings.svgSize,
            newLoadingSettings.svgColor
          );
        } else if (iconType === "dots") {
          svgIcon = notiflixIndicatorSvgDots(
            newLoadingSettings.svgSize,
            newLoadingSettings.svgColor
          );
        } else if (iconType === "pulse") {
          svgIcon = notiflixIndicatorSvgPulse(
            newLoadingSettings.svgSize,
            newLoadingSettings.svgColor
          );
        } else if (
          ...
          svgIcon = notiflixIndicatorSvgNotiflix(
            newLoadingSettings.svgSize,
            "#f8f8f8",
            "#32c682"
          );
        ...
        ntflxLoadingWrap.style.animationDuration =
        ...
        if (!window.document.getElementById(ntflxLoadingWrap.id)) {
          ...
          if (newLoadingSettings.clickToClose) {
            var loadingWrapElm = window.document.getElementById(
              ntflxLoadingWrap.id
            );
    ...
    var NotiflixLoadingChange = function (newMessage) {
      ...
      if (window.document.getElementById(loadingSettings.ID)) {
        ...
        if (newMessage.length > 0) {
          ...
          var oldMessageElm = window.document
          ...
          // there is no message element
            ...
            var messageWrap = window.document.getElementById(
              loadingSettings.ID
            );
    ...
    var NotiflixBlockUnblockElement = function (
      block,
      selector,
      iconType,
      message,
      ...
      if (
        newBlockSettings.className &&
        typeof newBlockSettings.className === "string"
      ) {
      ...
      var getQueryLimit =
        typeof newBlockSettings.querySelectorLimit === "number"
          ...
          : 200;
      var checkQueryLimit =
        getSelector.length >= getQueryLimit
          ? getQueryLimit
          : getSelector.length;
      ...
      if (block) {
        ...
        for (var i = 0; i < checkQueryLimit; i++) {
          ...
          var eachBlockElement = eachSelector.querySelectorAll(
            "[id^=" + blockSettings.ID + "]"
          );
          if (eachBlockElement.length < 1) {
            ...
            if (iconType) {
              if (iconType === "hourglass") {
                icon = notiflixIndicatorSvgHourglass(
                  newBlockSettings.svgSize,
                  newBlockSettings.svgColor
                );
              } else if (iconType === "circle") {
                icon = notiflixIndicatorSvgCircle(
                  newBlockSettings.svgSize,
                  newBlockSettings.svgColor
                );
              } else if (iconType === "arrows") {
                icon = notiflixIndicatorSvgArrows(
                  newBlockSettings.svgSize,
                  newBlockSettings.svgColor
                );
              } else if (iconType === "dots") {
                icon = notiflixIndicatorSvgDots(
                  newBlockSettings.svgSize,
                  newBlockSettings.svgColor
                );
              } else if (iconType === "pulse") {
                icon = notiflixIndicatorSvgPulse(
                  newBlockSettings.svgSize,
                  newBlockSettings.svgColor
                );
              } else {
                icon = notiflixIndicatorSvgStandard(
                  newBlockSettings.svgSize,
                  newBlockSettings.svgColor
                );
              }
            ...
            var posRatio =
              Math.round(intSvgSize - intSvgSize / 5).toString() + "px";
            ...
            if (message) {
              if (message.length > newBlockSettings.messageMaxLength) {
                message =
                  notiflixPlaintext(message)
                    .toString()
                    .substring(0, newBlockSettings.messageMaxLength) + "...";
              } else {
                message = notiflixPlaintext(message).toString();
              }
              messageHeight =
                Math.round(
                  parseInt(newBlockSettings.messageFontSize) * 1.4
                ).toString() + "px";
              messageElement =
                '<span style="top:' +
                posRatio +
            ...
            notiflixBlockWrap.id =
              blockSettings.ID + "-" + notiflixBlockElementCounter;
            notiflixBlockWrap.className =
              blockClassName +
              "-wrap" +
              (newBlockSettings.cssAnimation ? " with-animation" : "");
            notiflixBlockWrap.style.position = newBlockSettings.position;
            notiflixBlockWrap.style.zIndex = newBlockSettings.zindex;
            notiflixBlockWrap.style.background =
            ...
            notiflixBlockWrap.style.fontFamily =
              '"' + newBlockSettings.fontFamily + '"' + ", sans-serif";
            // block element off
            ...
            var eachSelectorPos = window
              .getComputedStyle(eachSelector)
              .getPropertyValue("position");
            eachSelectorPos =
              eachSelectorPos && typeof eachSelectorPos === "string"
                ? eachSelectorPos.toLowerCase()
                : "relative";

            var eachSelectorMinHeight = window
              .getComputedStyle(eachSelector)
              .getPropertyValue("min-height");
            var eachSelectorMinHeightNum = eachSelectorMinHeight.match(/\d/g);
            var currentMinHeight = Math.round(
              eachSelectorMinHeightNum.join("")
            );
            var expectedMinHeight = Math.round(
              (parseInt(messageHeight) + intSvgSize) * 1.5
            );
            var minHeightStyle = "";
            ...
            if (positions.indexOf(eachSelectorPos) <= -1) {
              var style =
                ...
                "." +
                blockClassName +
                "-position{position:relative!important;pointer-events:none;" +
                minHeightStyle +
                ";}" +
                "</style>";
      ...
      // unblock/remove
        ...
        var removeBlockElements = function (eachOne) {
          var timeout = setTimeout(function () {
            ...
            var eachOneStyle = window.document.getElementById(
              "Style-" + eachOneId
            );
            if (eachOneStyle) {
              eachOneStyle.remove();
        ...
        var selectorTimeout = setTimeout(function () {
          for (var i = 0; i < checkQueryLimit; i++) {
            ...
            eachBlockElement = eachSelector.querySelectorAll(
              "[id^=" + blockSettings.ID + "]"
            );
    ...
    var Notiflix = {
      ...
      Notify: {
        ...
        Init: function (userNotifyOpt) {
          // extend options
          newNotifySettings = extendNotiflix(
            true,
            notifySettings,
            userNotifyOpt
          );
          ...
          notiflixGoogleFont(
            newNotifySettings.useGoogleFont,
            newNotifySettings.fontFamily
          );
        },
        // Merge First Init
      ...
      Report: {
        ...
        Init: function (userReportOpt) {
          // extend options
          newReportSettings = extendNotiflix(
            true,
            reportSettings,
            userReportOpt
          );
          // use GoogleFonts if "Quicksand"
          notiflixGoogleFont(
            newReportSettings.useGoogleFont,
            newReportSettings.fontFamily
          );
        },
        // Merge First Init
      ...
      Confirm: {
        ...
        Init: function (userConfirmOpt) {
          // extend options
          newConfirmSettings = extendNotiflix(
            true,
            confirmSettings,
            userConfirmOpt
          );
          // use GoogleFonts if "Quicksand"
          notiflixGoogleFont(
            newConfirmSettings.useGoogleFont,
            newConfirmSettings.fontFamily
          );
        },
        // Merge First Init
      ...
      Loading: {
        ...
        Init: function (userLoadingOpt) {
          // extend options
          newLoadingSettings = extendNotiflix(
            true,
            loadingSettings,
            userLoadingOpt
          );
          // use GoogleFonts if "Quicksand"
          notiflixGoogleFont(
            newLoadingSettings.useGoogleFont,
            newLoadingSettings.fontFamily
          );
        },
        // Merge First Init
      ...
      Block: {
        ...
        Init: function (userBlockOpt) {
          ...
          // use GoogleFonts if "Quicksand"
          notiflixGoogleFont(
            newBlockSettings.useGoogleFont,
            newBlockSettings.fontFamily
          );
        },
        ...
        Merge: function (userBlockExtend) {
          // if initialized already
          if (newBlockSettings) {
            newBlockSettings = extendNotiflix(
              true,
              newBlockSettings,
              userBlockExtend
            );
